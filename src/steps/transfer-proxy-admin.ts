...
export const TRANSFER_PROXY_ADMIN: MigrationStep = async (state, { signer, gasPrice, gasLimit, ownerAddress }) => {
  ...
  const tx = await proxyAdmin.transferOwnership(ownerAddress, { gasPrice, gasLimit })
